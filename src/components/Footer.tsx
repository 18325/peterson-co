      ...
      <div className="footer__inner">
        ...
        <div className="footer__top">
          ...
          <div className="footer__brand">
            <Image
              src="/assets/identite_visuelle/LOGO PRINCIPAL COLORE/LOGO PRINCIPAL.png"
              alt="Peterson &co"
              width={180}
              height={50}
            ...
            />
            <Image
              src="/assets/identite_visuelle/VERSION MONOCHROME ALL/LOGO PRINCIPAL WHITE.png"
              alt="Peterson &co"
              width={180}
              height={50}
          ...
          {Object.entries(LINKS).map(([title, items]) => (
            <div key={title} className="footer__col">
              ...
              {items.map(({ label, href }) => (
                <Link key={label} href={href} className="footer__col-link">
                  {label}
                </Link>
              ))}
            </div>
        ...
        {/* ── Bas : copyright + paiements ── */}
        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} Peterson&amp;Co. Tous droits réservés.
          </p>
